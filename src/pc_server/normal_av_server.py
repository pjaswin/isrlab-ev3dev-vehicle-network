...
cq=0
emerg=0
prev_lane_first=mbox1_lane.read()
prev_lane_second=mbox2_lane.read()
...
while True:
    ...
    if prev_lane_first!=front_lane:
         print("AV1 Lane changed to ", front_lane)
    if prev_lane_second!=second_lane:
         print("AV2 Lane change to ",second_lane )
    prev_lane_first=front_lane
    prev_lane_second=second_lane
